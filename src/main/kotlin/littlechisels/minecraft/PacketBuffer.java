package littlechisels.minecraft;
...
import littlechisels.minecraft.nbt.NBTSizeTracker;
...
public class PacketBuffer extends ByteBuf
{
    ...
    public byte[] readByteArray(int maxLength)
    {
        ...
        if (i > maxLength)
        {
            throw new IllegalStateException("ByteArray with size " + i + " is bigger than allowed " + maxLength);
        }
        else
        {
    ...
    public int[] readVarIntArray(int maxLength)
    {
        ...
        if (i > maxLength)
        {
            throw new IllegalStateException("VarIntArray with size " + i + " is bigger than allowed " + maxLength);
        }
        else
        {
            int[] aint = new int[i];
    ...
    public long[] readLongArray(@Nullable long[] p_189423_1_, int p_189423_2_)
    {
        ...
        if (p_189423_1_ == null || p_189423_1_.length != i)
        {
            if (i > p_189423_2_)
            {
                throw new IllegalStateException("LongArray with size " + i + " is bigger than allowed " + p_189423_2_);
            }
    ...
    public String readStringFromBuffer(int maxLength)
    {
        ...
        if (i > maxLength * 4)
        {
            throw new IllegalStateException("The received encoded string buffer length is longer than maximum allowed (" + i + " > " + maxLength * 4 + ")");
        }
        else if (i < 0)
        {
        ...
        else
        {
            ...
            {
                throw new IllegalStateException("The received string length is longer than maximum allowed (" + i + " > " + maxLength + ")");
            }
            else
            {
                return s;
    ...
    public PacketBuffer writeString(String string)
    {
        ...
        {
            throw new IllegalStateException("String too big (was " + abyte.length + " bytes encoded, max " + 32767 + ")");
        }
        else
        {
